            ...
            <section className="bg-white py-32">
                <div className="mx-auto max-w-7xl px-6">
                    <div className="grid lg:grid-cols-[1.5fr_1fr] gap-16 items-start">
                        ...
                        >
                            <div className="relative w-full max-w-md rounded-2xl overflow-hidden shadow-[0_10px_50px_rgba(15,23,42,0.18)] transition-transform duration-300 ease-out hover:scale-[1.02] hover:shadow-[0_10px_10px_rgba(15,23,42,0.28)]">
                                <Image
