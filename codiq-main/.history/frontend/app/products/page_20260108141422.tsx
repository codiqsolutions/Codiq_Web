  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden bg-white pt-20 pb-16">
        {/* Animated Blue Circle - Traveling from top-right-center to left-center-corner */}
        <motion.div
        ...
        >
          <div className="h-[400px] w-[400px] rounded-full blur-3xl" style={{ backgroundColor: "#1D4ED8" }} />
        </motion.div>
