...
export default function Hero() {
  ...
  return (
    <section className="relative overflow-hidden bg-white pt-32 pb-36">
      ...
      <motion.div
        className="absolute left-1/2 top-[45%] -translate-x-1/2 -translate-y-1/2 z-0"
        animate={{
          scale: [1, 1.3, 1],
          opacity: [0.3, 0.5, 0.3],
          x: [0, 20, 0],
      ...
      >
        <div className="h-[600px] w-[600px] rounded-full blur-3xl" style={{ backgroundColor: "#1D4ED8" }} />
      </motion.div>
