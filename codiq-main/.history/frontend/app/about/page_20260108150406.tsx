        ...
        <>
            ...
            <section className="bg-white py-32">
                <div className="mx-auto max-w-7xl px-6">
                    ...
                    <div className="relative space-y-14 pl-12">
                        {/* Timeline line */}
                        <div className="absolute left-4 top-2 bottom-5 w-px bg-slate-200" />
                        ...
                        {[
                            ...
                            >
                                {/* Timeline dot */}
                                <div className="absolute -left-[6px] top-7 h-3 w-3 rounded-full bg-blue-500 shadow-[0_0_0_6px_rgba(59,130,246,0.15)]" />

                                <div className="text-6  xl font-extrabold bg-gradient-to-br from-blue-200 to-indigo-200 bg-clip-text text-transparent">
